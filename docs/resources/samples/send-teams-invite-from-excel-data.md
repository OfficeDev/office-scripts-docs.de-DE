...
---
# <a name="send-teams-meeting-from-excel-data"></a><span data-ttu-id="a4f46-103">Senden Teams Besprechung aus Excel Daten</span><span class="sxs-lookup"><span data-stu-id="a4f46-103">Send Teams meeting from Excel data</span></span>

<span data-ttu-id="a4f46-104">Diese Lösung zeigt, wie Sie Office Skripts und Power Automate-Aktionen verwenden, um Zeilen aus der Excel-Datei auszuwählen und sie zu verwenden, um eine Teams-Besprechungs-Einladung zu senden und dann Excel.</span><span class="sxs-lookup"><span data-stu-id="a4f46-104">This solution shows how to use Office Scripts and Power Automate actions to select rows from Excel file and use it to send a Teams meeting invite then update Excel.</span></span>

## <a name="example-scenario"></a><span data-ttu-id="a4f46-105">Beispielszenario</span><span class="sxs-lookup"><span data-stu-id="a4f46-105">Example scenario</span></span>

* <span data-ttu-id="a4f46-106">Ein Personalreferent verwaltet den Interviewzeitplan der Kandidaten in einer Excel Datei.</span><span class="sxs-lookup"><span data-stu-id="a4f46-106">An HR recruiter manages the interview schedule of candidates in an Excel file.</span></span>
* <span data-ttu-id="a4f46-107">Der Personalreferent muss die Teams an den Kandidaten und die Interviewer senden.</span><span class="sxs-lookup"><span data-stu-id="a4f46-107">The recruiter needs to send the Teams meeting invite to the candidate and interviewers.</span></span> <span data-ttu-id="a4f46-108">Die Geschäftsregeln sind:</span><span class="sxs-lookup"><span data-stu-id="a4f46-108">The business rules are to select:</span></span>

    <span data-ttu-id="a4f46-109">(a) Lädt nur diejenigen ein, für die die Einladung noch nicht wie in der Dateispalte aufgezeichnet gesendet wurde.</span><span class="sxs-lookup"><span data-stu-id="a4f46-109">(a) Invites to only those for whom the invite isn't already sent as recorded in the file column.</span></span>

    <span data-ttu-id="a4f46-110">(b) Interviewtermine in der Zukunft (keine vergangenen Datumsangaben).</span><span class="sxs-lookup"><span data-stu-id="a4f46-110">(b) Interview dates in the future (no past dates).</span></span>

* <span data-ttu-id="a4f46-111">Der Personalreferent muss die Excel mit der Bestätigung aktualisieren, dass alle Teams für die berechtigten Datensätze gesendet wurden.</span><span class="sxs-lookup"><span data-stu-id="a4f46-111">The recruiter needs to update the Excel file with the confirmation that all Teams meetings have been sent for the eligible records.</span></span>

<span data-ttu-id="a4f46-112">Die Lösung besteht aus drei Teilen:</span><span class="sxs-lookup"><span data-stu-id="a4f46-112">The solution has 3 parts:</span></span>

1. <span data-ttu-id="a4f46-113">Office Skript zum Extrahieren von Daten aus einer Tabelle basierend auf Bedingungen und gibt ein Array von Objekten als JSON-Daten zurück.</span><span class="sxs-lookup"><span data-stu-id="a4f46-113">Office Script to extract data from a table based on conditions and returns an array of objects as JSON data.</span></span>
1. <span data-ttu-id="a4f46-114">Die Daten werden dann an die Teams **Erstellen** Teams Besprechungsaktion zum Senden von Einladungen gesendet.</span><span class="sxs-lookup"><span data-stu-id="a4f46-114">The data is then sent to the Teams **Create a Teams meeting** action to send invites.</span></span> <span data-ttu-id="a4f46-115">Senden Sie Teams Besprechung pro Instanz im JSON-Array.</span><span class="sxs-lookup"><span data-stu-id="a4f46-115">Send one Teams meeting per instance in the JSON array.</span></span>
1. <span data-ttu-id="a4f46-116">Senden Sie dieselben JSON-Daten an ein Office Skript, um den Status der Einladung zu aktualisieren.</span><span class="sxs-lookup"><span data-stu-id="a4f46-116">Send the same JSON data to another Office Script to update the status of the invitation.</span></span>

## <a name="sample-excel-file"></a><span data-ttu-id="a4f46-117">Beispieldatei Excel Datei</span><span class="sxs-lookup"><span data-stu-id="a4f46-117">Sample Excel file</span></span>

<span data-ttu-id="a4f46-118">Laden Sie die Datei <a href="hr-schedule.xlsx">hr-schedule.xlsx, </a> die in dieser Lösung verwendet wird, herunter, und testen Sie sie selbst!</span><span class="sxs-lookup"><span data-stu-id="a4f46-118">Download the file <a href="hr-schedule.xlsx">hr-schedule.xlsx</a> used in this solution and try it out yourself!</span></span>

## <a name="sample-code-select-filtered-rows-from-table-as-json"></a><span data-ttu-id="a4f46-119">Beispielcode: Wählen Sie gefilterte Zeilen aus der Tabelle als JSON aus.</span><span class="sxs-lookup"><span data-stu-id="a4f46-119">Sample code: Select filtered rows from table as JSON</span></span>
...
## <a name="sample-code-mark-as-invited"></a><span data-ttu-id="a4f46-120">Beispielcode: Als eingeladen markieren</span><span class="sxs-lookup"><span data-stu-id="a4f46-120">Sample code: Mark as invited</span></span>
...
## <a name="training-video-send-a-teams-meeting-from-excel-data"></a><span data-ttu-id="a4f46-121">Schulungsvideo: Senden Teams Besprechung aus Excel Daten</span><span class="sxs-lookup"><span data-stu-id="a4f46-121">Training video: Send a Teams meeting from Excel data</span></span>

<span data-ttu-id="a4f46-122">[Sehen Sie sich an, wie Sudhi Ramamurthy dieses Beispiel auf YouTube durchspazieren.](https://youtu.be/HyBdx52NOE8)</span><span class="sxs-lookup"><span data-stu-id="a4f46-122">[Watch Sudhi Ramamurthy walk through this sample on YouTube](https://youtu.be/HyBdx52NOE8).</span></span>
