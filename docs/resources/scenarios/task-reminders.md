...
In diesem Szenario [werden Power Automate](https://flow.microsoft.com) und [Microsoft Teams](https://www.microsoft.com/microsoft-365/microsoft-teams/group-chat-software) verwendet. Sie müssen beide mit dem Konto verknüpft sein, das Sie für die Entwicklung von Office Skripts verwenden. Für den kostenlosen Zugriff auf ein Microsoft Developer-Abonnement, um mehr über diese Anwendungen zu erfahren und mit diesen zu arbeiten, sollten Sie am [Microsoft 365 Entwicklerprogramm](https://developer.microsoft.com/microsoft-365/dev-program) teilnehmen.
...
1. Wählen Sie **"Manuell auslösen" aus** den Optionen aus, und wählen Sie " **Erstellen**" aus.
...
1. Als Nächstes muss der Fluss jeden Mitarbeiter in dem array verarbeiten, das vom Skript zurückgegeben wird. Wählen Sie **"Neu" aus**, und wählen Sie dann "**Adaptive Karte an einen Teams Benutzer posten" aus, und warten Sie auf eine Antwort**.
