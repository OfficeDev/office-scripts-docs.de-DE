...
11. Der Fluss muss das **Skript Get People aufrufen,** um alle Mitarbeiter mit leeren Statusfeldern zu erhalten. Drücken **Sie den Schritt** Neu, und wählen Excel Online **(Business) aus.** Wählen Sie unter **Aktionen** die Option **Skript ausführen (Vorschau)** aus. Geben Sie die folgenden Einträge für den Flussschritt an:
...
16. Drücken Sie **im Abschnitt Auf jeden** Block anwenden nach dem Post an Adaptive Card to a Teams user and wait for a **response** die Aktion **Hinzufügen.** Wählen **Excel Online (Business) aus.** Wählen Sie unter **Aktionen** die Option **Skript ausführen (Vorschau)** aus. Geben Sie die folgenden Einträge für den Flussschritt an:
