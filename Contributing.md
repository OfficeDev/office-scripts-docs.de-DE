...
* Fordern Sie die neue Dokumentation in der [Excel für die UserVoice-](https://excel.uservoice.com/forums/274580-excel-for-the-web?category_id=143439) Website an.
...
**Hinweis**: mit dieser Methode können Sie gleichzeitig zu einem Artikel beitragen.
...
**Hinweis**: die meisten der Informationen in diesem Abschnitt finden Sie in den [GitHub-Hilfe] Artikeln.  Wenn Sie mit Git und GitHub vertraut sind, fahren Sie mit dem Abschnitt zum **Einsenden und Bearbeiten von Inhalten** mit speziellen Informationen zum Code-/Inhaltsfluss dieses Repositorys fort.
...
Beispiel: Wenn Ihre lokale Zweigstelle X erfolgreich mit der officedev/Office-Scripts-docs-Master Verzweigung zusammengeführt wurde und Sie zusätzliche Updates für den zusammengeführten Inhalt erstellen möchten. Erstellen Sie eine neue lokale Verzweigung x2 aus der Master Verzweigung officedev/Office-Scripts-docs. Öffnen Sie dazu GitBash, und führen Sie die folgenden Befehle aus:
